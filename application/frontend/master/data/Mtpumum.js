...
Ext.form.Field.prototype.msgTarget = 'side';
	...
	/* var paging_klsrawat = new Ext.PagingToolbar({
		pageSize: pageSize,
		store: ds_klsrawat,
		displayInfo: true,
	...
	function Addrecord(grid, rowIndex, columnIndex){	
		...
		var rec = ds_tpumum.getAt(rowIndex);
	...
	afteredit: function(roweditor, changes, record, rowIndex) {
		...
		Ext.Ajax.request({
			url: BASE_URL + 'tpumum_controller/update',
			params: {
	...
	function fnEditKlstarif(){
		Ext.Ajax.request({
			url: BASE_URL + 'tpumum_controller/update_klstarif',
			params: {
...
*/
	...
	function updateTpumum(field, value){		
		Ext.Ajax.request({
			url: BASE_URL + 'tpumum_controller/update1field_tpumum',
			params: {
