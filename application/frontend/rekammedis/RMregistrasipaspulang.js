function RMregistrasipaspulang(){
	...
	var rencanapulang_form = new Ext.form.FormPanel({
		id: 'fp.rencanaplg',
		title: 'Registrasi Pasien Pulang',
	...
	items: [{
			...
			items: [{
				...
				items: [{
					...
					xtype: 'combo', fieldLabel: 'Keadaan Keluar',
					id: 'cb.keadaankeluar',
					width: 300,
						store: ds_stkeluar, valueField: 'idstkeluar', displayField: 'nmstkeluar',
	...
	function simpan(namaForm){
		...
		form_nya.getForm().submit({
			url: BASE_URL + 'regispaspulang_controller/update_regispaspulang',
			method: 'POST',
		//	success: function(rencanapulang_form, o) {
			/* 	if (o.result.success == true) {
					Ext.MessageBox.alert('Informasi', 'Simpan Data Berhasil');
					Ext.getCmp('tf.noregis').setValue(o.result.noreg);
