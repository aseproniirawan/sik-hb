<?php
class Printnotakasir extends Controller {
    ...
    function notakui($noreg) {
		...
		foreach($notadet AS $i=>$val){
			...
			$isi .= "<tr>
				...
				<td width=\"80%\"><font size=\"8\" face=\"Helvetica\">". $tarifall['nmitem'] ."</font></td>
				<td width=\"15%\"><font size=\"8\" face=\"Helvetica\">Rp. ". number_format($tarif,0,',','.') ."</font></td>
			</tr>";
		}
			...
			<table border=\"1px\" cellpadding=\"2\">
			  <tbody>
				<tr align=\"center\">
					...
					<td width=\"80%\"><font size=\"8\" face=\"Helvetica\">Item Pelayanan</font></td>
					<td width=\"15%\"><font size=\"8\" face=\"Helvetica\">Subtotal</font></td>
				</tr>". $isi
			  ."</tbody>
				<tr>
					<td width=\"85%\"><p align=\"right\"><font size=\"8\" face=\"Helvetica\"> Total </font></p></td>
					<td width=\"15%\"><font size=\"8\" face=\"Helvetica\">Rp. ". number_format($total,0,',','.') ."</font></td>
				</tr>
			</table>
		";
		...
		$this->pdf->Output('nota_dan_kuitansi.pdf', 'I');
			//============================================================+
			// END OF FILE
			//============================================================+
	}
